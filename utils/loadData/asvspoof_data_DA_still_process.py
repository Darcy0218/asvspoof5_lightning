...
class asvspoof_dataModule(L.LightningDataModule):
        def __init__(self,args):
                ...
                # label file
                self.train_protocols_file = "/data8/wangzhiyong/project/fakeAudioDetection/asvspoof5/asvspoof5/spoof5/ASVspoof5.train.metadatatoy.txt"
                self.dev_protocols_file = "/data8/wangzhiyong/project/fakeAudioDetection/asvspoof5/asvspoof5/spoof5/ASVspoof5.dev.metadatatoy.txt"
                # flac file dir
                self.train_set="/data8/wangzhiyong/project/fakeAudioDetection/asvspoof5/asvspoof5/flac_T/"
                self.dev_set="/data8/wangzhiyong/project/fakeAudioDetection/asvspoof5/asvspoof5/flac_D/"
                # test set 
